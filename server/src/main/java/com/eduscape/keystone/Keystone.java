...
@Entity(name = "keystone")
@IdClass(KeystoneKey.class)
@NoArgsConstructor
public class Keystone {
    ...
    public Keystone(int schoolID, short year, String subject, String group, int total, float percentAdvanced, float percentProficient, float percentBasic, float percentBelowBasic) {
